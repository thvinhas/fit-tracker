export const buttonPrimaryLinkClass =
  "font-bold rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 active:scale-[0.96] bg-primary text-[#181510] shadow-glow hover:shadow-glow-lg hover:scale-[1.02] px-5 py-4 text-base min-h-[56px] w-full relative overflow-hidden group";
...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-primary text-[#181510] shadow-glow hover:shadow-glow-lg hover:scale-[1.02] before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/20 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity",
    secondary:
      "bg-surface3 text-text-primary border-border-subtle hover:bg-surface4 hover:border-border-hover shadow-inner-glow",
    danger: "bg-dangerDim text-danger hover:bg-danger/20",
